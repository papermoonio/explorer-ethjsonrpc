        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={250}>
            <BarChart data={data}>
              ...
              <Tooltip contentStyle={{ backgroundColor: 'var(--color-popover)', border: '1px solid var(--color-border)', color: 'var(--color-popover-foreground)', borderRadius: 6 }} itemStyle={{ color: 'var(--color-chart-2)' }} formatter={(value) => [`${String(value)} M gas`, 'Gas Used']} />
              <Bar dataKey="gasUsed" name="Gas Used (M)" fill="var(--color-chart-2)" radius={[2, 2, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
